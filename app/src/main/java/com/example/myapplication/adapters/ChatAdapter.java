...
import com.example.myapplication.databinding.ItemContainerReceivedBinding;
...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    static class ReceiverMessageViewHolder extends RecyclerView.ViewHolder {
        ...
        ReceiverMessageViewHolder (ItemContainerReceivedBinding itemContainerReceivedBinding) {
